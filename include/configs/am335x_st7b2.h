...
#ifndef __CONFIG_AM335X_ST7B2_H
#define __CONFIG_AM335X_ST7B2_H
...
#define CONFIG_SYS_LDSCRIPT		"board/tailyn/st7b2/u-boot.lds"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"findfdt="\
		...
		"if test $board_name = A335X_SK; then " \
			"setenv fdtfile am335x-st7b2.dtb; fi; " \
